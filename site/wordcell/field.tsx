...
const NOTES: readonly FieldNote[] = [
  ...
  },
  {
    ...
    body: "Indexes rebuild from the files. Anything we ship must read the files directly.",
    tags: ["architecture"],
  ...
  },
  {
    ...
    type: "concept",
    title: "Stigmergy",
    body: "Coordination through traces left in a shared environment.",
  ...
  },
  {
    ...
    body: "Patterns nest: each one depends on the smaller patterns inside it and the larger ones around it.",
  ...
  },
  {
    ...
    body: "If it does, review the link before the next release. See [[graph-authority]].",
    tags: ["maintenance"],
  ...
  },
  {
    id: "hayek",
    type: "source",
    title: "Hayek on local knowledge",
  ...
  },
  {
    id: "dev-journal",
    type: "decision",
    title: "Dev journal: context",
    body: "Look up what [[parser-contract]] already decided before re-deriving it.",
    tags: ["infrastructure"],
  ...
  },
  {
    ...
    body: "Chapter notes on how the immune system tells self from non-self.",
    tags: ["recognition"],
 ...
 * vault with scopes, rules, evals, and the people behind them. */
export const DEVELOPER_NOTES: readonly FieldNote[] = [
  {
    id: "parser-contract",
    type: "concept",
    title: "Parser contract",
    body: "Retries stop after three attempts, and callers get a typed failure.",
    tags: ["infrastructure"],
  ...
  },
  {
    ...
    body: "Run the tests before every commit. Regenerate the docs when a command changes.",
  ...
  },
  {
    id: "eval-rerun",
    type: "decision",
    title: "Eval corpus stays frozen",
    body: "Rerun evals on the same corpus so scores stay comparable across releases.",
    tags: ["evals"],
  ...
  },
  {
    ...
    body: "Resume from the last written note. The vault is the handoff.",
  ...
  },
  {
    id: "provenance",
    type: "concept",
    title: "Keep the source with the match",
    body: "A match without its commit or source is hard to trust. See [[half-life]].",
  ...
  },
  {
    id: "field-notes",
    type: "source",
    title: "Search latency notes",
    body: "Exact search reads the Markdown directly. Semantic search also loads a local model.",
  ...
  },
  {
    ...
    body: "Tests green, review threads resolved, changelog updated, then tag the release.",
  ...
  },
  {
    id: "publish-decision",
    type: "decision",
    title: "Publish a digest",
    body: "The site includes only the notes we select. The rest of the vault stays private.",
    tags: ["release"],
  ...
  },
  {
    ...
    body: "If it does, flag the link for review. See [[graph-authority]].",
  ...
  },
  {
    ...
    type: "person",
    title: "Ada Mikkelsen",
    body: "Maintains the eval harness. Reviewing the results table before release.",
    tags: ["evals"],
...
export const DEVELOPER_EDGES: readonly FieldEdge[] = [
  ...
  { from: "agents-rules", to: "release-checklist", label: "governs", pulse: true },
  { from: "repo-scopes", to: "parser-contract", label: "scopes" },
  { from: "ada", to: "eval-rerun", label: "maintains" },
